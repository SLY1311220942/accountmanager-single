package com.sly.accountmanager.utils.vcode;
...
{	
    ...
    protected static final int RDIUSBIAS = (((int) 1) << RADIUSBIASSHIFT);
    /**
     *  and decreases by a 
     */
    protected static final int INITRADIUS = (INITRAD * RDIUSBIAS); 
    /**
    ...
    public void inxbuild() {
        ...
        for (j = previouscol + 1; j < int256; j++) {
        	/* really 256 */
