						...
						<div class="row" style="margin-top: 10px; margin-bottom: 8px;">
							...
							<div class="wrap1">
								...
								<div style="margin-left: 48%;margin-bottom: 10px;">
									<button type="button" onclick="billTypeUpdate(this)" class="btn btn-info ladda-button" data-style="zoom-in" data-size="s" style="margin-bottom: 10px;margin-top: 10px;">
