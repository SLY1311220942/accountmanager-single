...
<html>
						...
						<div class="row" style="margin-top: 10px; margin-bottom: 8px;">
							...
							<div class="wrap1">
								...
								<div class="col-md-12 column ui-sortable" style="margin-top: 20px;">
									<form class="form-horizontal required-validate" id="billAddForm">
										<input type="hidden" id="token" name="token" value="${ACCOUNT_BILL_ADD_TOKEN}" />
										<div class="view">
											<div class="row">
	...
	<script src="${pageContext.request.contextPath }/resource/account/js/account/bill/billAdd.js"></script>
	<script>
		$(function() {
			validator();
			...
			$('#billTime').datetimepicker({
                ...
                $('#billAddForm').data('bootstrapValidator')
