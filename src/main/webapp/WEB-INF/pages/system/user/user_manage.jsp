...
<html>
						...
						<div class="row" style="margin-top: 10px; margin-bottom: 8px;">
							...
							<div class="wrap1">
								...
								<div class="col-md-12 column ui-sortable" style="margin-top: 20px;">
									<form class="form-horizontal required-validate" id="userSearch">

										<div class="view">
											<div class="row">
												<div class="form-group col-md-6  column ui-sortable">
													<label for="username" class="col-sm-4 control-label" style="text-align: right; float: left;">用户名称：</label>
													<div class="col-sm-6">
								...
								<div style="margin-left: 46%;margin-bottom: 10px;">
									<button type="button" onclick="userSearch()" class="btn btn-info" style="margin-bottom: 10px;margin-top: 10px;">查&nbsp;&nbsp;&nbsp;询</button>
									<button type="button" onclick="toUserAdd()" class="btn btn-info" style="margin-bottom: 10px;margin-top: 10px;">新&nbsp;&nbsp;&nbsp;增</button>
								</div>
							</div>
							<!-- 数据列表 -->
							<div class="wrap2">
	...
	<script src="${pageContext.request.contextPath }/resource/account/js/system/user/userManage.js"></script>
	<script>
		validator();
		loadUserList();
