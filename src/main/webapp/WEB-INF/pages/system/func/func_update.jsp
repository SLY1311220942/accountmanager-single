...
<html>
						...
						<div class="row" style="margin-top: 10px; margin-bottom: 8px;">
							...
							<div class="wrap1">
								...
								<div class="col-md-12 column ui-sortable" style="margin-top: 20px;">
									<form class="form-horizontal required-validate" id="funcUpdateForm">
										<input type="hidden" id="funcId" name="funcId" value="${funcId}" />
										<input type="hidden" id="token" name="token" value="${SYSTEM_FUNC_UPDATE_TOKEN}" />
										<div class="view">
											<div class="row">
								...
								<div style="margin-left: 48%;margin-bottom: 10px;">
									<button type="button" onclick="funcUpdate(this)" class="btn btn-info ladda-button" data-style="zoom-in" data-size="s" style="margin-bottom: 10px;margin-top: 10px;">
	...
	<script src="${pageContext.request.contextPath }/resource/account/js/system/func/funcUpdate.js"></script>
